...
VehiclePanel.propTypes = {
    ...
    fare: PropTypes.shape({
        car: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        moto: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        auto: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    }).isRequired,
};
